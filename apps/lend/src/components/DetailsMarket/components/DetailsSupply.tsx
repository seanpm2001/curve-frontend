...
import DetailsSupplyTotalStaked from '@/components/DetailsMarket/components/DetailsSupplyTotalStaked'
    ...
    <Wrapper>
      ...
      <StyledDarkContent>
        <Box grid gridGap={3}>
          ...
          <DetailsSupplyTotalStaked rChainId={rChainId} rOwmId={rOwmId} />
          <div>
            <DetailsContracts
              rChainId={rChainId}
